...
function UploadImages({triggleUploadImages,setLoader,carInfo,mode}) {
    console.log("init triggleUploadImages:",triggleUploadImages);
    ...
    useEffect(()=>{
        ...
        {
            console.log("triggleUploadImages:",triggleUploadImages);
            UploadImageToServer();
        }
    },[triggleUploadImages])
    ...
    const UploadImageToServer=async()=>{
       ...
       await selectedFileList.forEach(async(file)=>{
            ...
            const storageRef=ref(storage,'wheels360/'+fileName);
            const metaData={
